      ...
      this.props.form.validateFields( function checker (err, values)  {
        ...
        if (!err) {
          self.props.updInvoiceHandler({
            ...
            updCurrencySymbol: (
              self.state.preCur? self.state.preCur : self.state.postCur ? 
                '' : self.props.invoiceToEdit.currencySymbol
            ),
            updCurrencyCode: (
              self.state.postCur ? self.state.postCur : self.state.preCur ? 
                '' : self.props.invoiceToEdit.currencyCode
            ),
        ...
        <Row key={k+"row"} className={styles.denseHeight}> 
          <div key={k+"wrapdiv"}>
            ...
            <Col key={k+"itemCol"} span={4}>
              <Input key={k+"item"} 
                onChange={this.handleItemName.bind(this, k)} 
                placeholder={this.state.items[k]["name"] ||  "item or service"} 
                className={styles.borderless} style={{ width: '95%' }}  
              />
            </Col>
            ...
            <Col key={k+"descrCol"} span={7}>
              <Input type="textarea" 
                key={k+"descr"} 
                onChange={this.handleItemDescription.bind(this, k)} 
                placeholder={this.state.items[k]["description"] ||  "description"} 
                className={styles.borderless} style={{ width: '98%' }}  
              />
            </Col>
            ...
            <Col key={k+"priceCol"} span={4} >
              <div className={styles.horizontalCentering}>
                ...
                {this.state.preCur ? this.state.preCur : this.state.postCur ? 
                  '' : this.props.invoiceToEdit.currencySymbol }
                ...
                {this.state.postCur ? this.state.postCur : this.state.preCur ? 
                  '' : this.props.invoiceToEdit.currencyCode }
              </div>
            </Col>
      ...
      <Form onSubmit={this.handleSubmit.bind(this)} className={styles.form}>
        ...
        >
          { getFieldDecorator('invoiceName', {
            rules: [{ required: true, message: 'Please name your document' }], 
              initialValue:  this.props.invoiceToEdit.invoiceTitle || "Invoice"
            })(
          ...
          <Col span={12}>
            ...
            >
              { getFieldDecorator('companyName',  {
                ...
                initialValue:  this.props.invoiceToEdit.companyName || ''
              })(
          ...
          <Col span={12} style={{marginBottom:"10px"}}>
            ...
            >
              { getFieldDecorator('invoiceSummary', {
                initialValue:  this.props.invoiceToEdit.invoiceSummary || ''
              })(
        ...
        <Row>
          ...
          <Col span={12}>
            ...
            >
              <div>
                <BillFrom id={this.props.id} invoiceToEdit={this.props.invoiceToEdit} 
                  addCompanyHandler={this.props.addCompanyHandler} 
                  updInvoiceHandler={this.props.updInvoiceHandler} 
                />
              </div>
            </FormItem>
          </Col>
          ...
          <Col span={12}>
            ...
            >
              { getFieldDecorator('invoiceNumber', { 
                initialValue: this.props.invoiceToEdit.invoiceNumber || 1 
              })(
                <InputNumber min={1} />
              )}
            </FormItem>
          ...
          <Col span={12}>
            ...
            >
              { getFieldDecorator('customerName',  {
                ...
                initialValue:  this.props.invoiceToEdit.customerName || '' 
              })(
          ...
          <Col span={12}>
            ...
            >
              { getFieldDecorator('invoiceDate', {
                initialValue:  moment(this.props.invoiceToEdit.invoiceDate) || null
              })(
        ...
        <Row>
          ...
          <Col span={12}>
            ...
            >
                <div>
                  <BillTo id={this.props.id} invoiceToEdit={this.props.invoiceToEdit} 
          ...
          <Col span={12}>
            ...
            >
              { getFieldDecorator('paymentDue', {
                rules: [{ required: true, message: 'Please specify when the invoice is due' }], 
                initialValue:  moment(this.props.invoiceToEdit.paymentDue) || null
              })(
                 <DatePicker format={dateFormat} />
              )}
            </FormItem>
          ...
          <Col span={4} className={styles.denseHeight}>
            <FormItem wrapperCol={{ span: 24 }}>
              { getFieldDecorator('items', {
                rules: [{ required: true, message: 'Please classify your items/services ' }], 
                initialValue:  this.props.invoiceToEdit.itemsName || "Items"
              })(
          ...
          <Col span={7} className={styles.denseHeight}>
            <FormItem wrapperCol={{ span: 24 }}>
              { getFieldDecorator('itemsDescription', {
                rules: [{ required: true, message: 'Please specify description way of your items/services ' }], 
                initialValue:  this.props.invoiceToEdit.itemsDescriptionName || "Description"
              })(
                <Input className={styles.borderless} />
              )}
            </FormItem>
          ...
          <Col span={3} className={styles.denseHeight}>
            <FormItem> 
              { getFieldDecorator('itemsQuantity', {
                rules: [{ required: true, message: 'Please specify quantity name of your items/services ' }], 
                initialValue: this.props.invoiceToEdit.quantityName || "Quantity"
              })(
          ...
          <Col span={4} className={styles.denseHeight}>
            <FormItem >
              { getFieldDecorator('itemsPrice', {
                rules: [{ required: true, message: 'Please specify description way of pricing items/services ' }], 
                initialValue: this.props.invoiceToEdit.unitPriceName || "Price"
              })(
                <Input className={styles.borderless} style={{textAlign:"center", width:"90%"}} />
              )}
            </FormItem>
          ...
          <Col span={5} className={styles.denseHeight}>
            <FormItem >
              { getFieldDecorator('Amount', {
                rules: [{ required: true, message: 'Please specify description way of total charge for an item or service ' }], 
                initialValue: this.props.invoiceToEdit.totalName || "Amount"
              })(
                <Input className={styles.borderless} style={{textAlign:"center", width:"90%"}} />
              )}
            </FormItem>
            ...
            >
              { getFieldDecorator('tax', {initialValue: this.props.invoiceToEdit.tax 
                ...
                <Row>
                  ...
                  <Col className={this.state.hideCur ? styles.hidden : this.state.preCur ? 
                    styles.hidden : this.props.invoiceToEdit.currencySymbol  ? styles.hidden : this.state.postCur ?
                     "" : this.props.invoiceToEdit.currencyCode ? '' : styles.hidden} span={2} offset={1}
                  >
          ...
          <Col span={9} >
            ...
            >
              { getFieldDecorator('discount', { 
                initialValue: this.props.invoiceToEdit.discount
              })(
                <Row>
          ...
          <Col span={9} >
            ...
            >
              { getFieldDecorator('addCharge', { 
                initialValue: this.props.invoiceToEdit.additionalCharge
              })(
                <Row>
                  <Col span={2}>
                    <div className={this.state.hideCur && !this.state.preCur ? styles.hidden :  ""} 
            ...
            <FormItem labelCol={{ span: 2 }}
             ...
             >
              { getFieldDecorator('notes', {
                initialValue:  this.props.invoiceToEdit.notes || '' 
              })(
                <Input type="textarea" />
              )}
            </FormItem>
            ...
            <FormItem labelCol={{ span: 2 }}
             ...
             >
              { getFieldDecorator('terms', {
                initialValue:   this.props.invoiceToEdit.footer || '' 
              })(
                <Input type="textarea" />
              )}
            </FormItem>
